...
function sendGCM($title, $message, $topic, $pageid, $pagename)
{
    ...
    $headers = array(
        'Authorization: key=' . "AAAAouWDldw:APA91bEP4OhAifLLqMaK__pGuwB7gJvdRrDH3HGLH-PCcjlUg3HDXLJpo5_ZEJOLK_k3mtOD_x4Rh5_ym9hfs9hb5T7a0ZZeMaFJFospjC9KpFvDGgXrdE0UKfEVW1h9XTTbPklfK1K-",
